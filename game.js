...
function draw(){
  ...
  if (me){
    ...
    ctx.beginPath();
    ctx.arc(me.x * cell + cell / 2, me.y * cell + cell / 2, cell * 0.4, 0, Math.PI * 2);
    ctx.fill();
  }
  ...
  if (other){
    ...
    ctx.beginPath();
    ctx.arc(other.x * cell + cell / 2, other.y * cell + cell / 2, cell * 0.4, 0, Math.PI * 2);
    ctx.fill();
  }
}
...
function send(obj){
  if (ws && ws.readyState === 1){
    ...
    console.log('WS not ready, cannot send:', obj);
  }
}
